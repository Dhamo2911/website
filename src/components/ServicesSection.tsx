...
const SERVICES = [
  ...
  {
    number: '05',
    title: 'AI Automations with Agents',
    description:
      'AI Automation with Agents enables intelligent systems to autonomously perform tasks, make decisions, and streamline workflows with minimal human intervention.',
  },
];
