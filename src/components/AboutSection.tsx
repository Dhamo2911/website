                      ...
                      <div className="flex flex-col gap-5 sm:gap-6">
                        {[
                          ...
                          },
                          {
                            ...
                            items: ['React', 'Tailwind', 'Pandas', 'NumPy', 'Node.js', 'Mongo DB'],
                          },
                          {
                            label: 'Tools & Platforms',
                            items: ['Figma', 'Git', 'GitHub', 'Power BI', 'Canva', 'Excel', 'N8N'],
                          },
                          {
                            label: 'AI & GenAI',
