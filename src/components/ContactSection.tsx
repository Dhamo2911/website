...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'dhamoofficial08@gmail.com',
    href: 'mailto:dhamoofficial08@gmail.com',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    ...
    href: 'https://wa.me/919443020374',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: 'in/dhamothara-as',
    href: 'https://www.linkedin.com/in/dhamothara-as',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@Dhamo2911',
    href: 'https://github.com/Dhamo2911',
  },
];
